...
--
-- Host: localhost    Database: drupal-7.23.production
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=69 DEFAULT CHARSET=utf8 COMMENT='Table that contains logs of all system events.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2015-01-12 19:02:56
